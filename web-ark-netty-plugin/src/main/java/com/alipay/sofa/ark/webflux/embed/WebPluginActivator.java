 ...
 */
package com.alipay.sofa.ark.webflux.embed;

import com.alipay.sofa.ark.common.log.ArkLoggerFactory;
import com.alipay.sofa.ark.spi.model.PluginContext;
import com.alipay.sofa.ark.spi.service.PluginActivator;
import com.alipay.sofa.ark.spi.web.EmbeddedServerService;
import com.alipay.sofa.ark.webflux.embed.netty.EmbeddedServerServiceImpl;
...
public class WebPluginActivator implements PluginActivator {
    ...
    private final EmbeddedServerService<Channel> embeddedServerService = new EmbeddedServerServiceImpl();
    ...
    public void stop(PluginContext context) {
        Channel webServer = null;
        if (embeddedServerService.getEmbedServer() != null) {
            webServer = embeddedServerService.getEmbedServer();
        }
        if (webServer != null) {
            try {
                webServer.close();
